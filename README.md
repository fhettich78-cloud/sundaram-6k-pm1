...
- Twin-prime count at x ≤ 1.2·10⁶: 9,599 — within 0.2% of the Hardy-Littlewood
  asymptotic 2·C₂·Li₂(x) ≈ 9,613.
- Twin-prime spectrum is a scaled copy of the residual spectrum — both
  inherit the same modular harmonics from small primes.

## Performance

Serial Python, ~5× slower than a tight Eratosthenes implementation.
...
- `dpim_full.py` — sieve + verification against Eratosthenes + benchmark + twin-prime count
